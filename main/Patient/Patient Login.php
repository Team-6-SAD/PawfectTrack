...
<head>
    ...
    <style>
     ...
     .container{
        background-image: url('../img/img-login-register/Group 2314.png');
...
<body>
    <div class="container d-flex justify-content-center align-items-center margin-bottom px-5 py-5">
...
<div class="modal fade" id="forgotPasswordModal" tabindex="-1" role="dialog" aria-labelledby="forgotPasswordModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="col-md-12 w-100 px-5">
        <form action="patient-backend/forgot-password-patient.php" method="post"> <!-- Change the action to your PHP script -->
            ...
            <div class="align-items-center justify-content-center d-flex mb-3">
                <button type="submit" id="forgot-pass-submit"style="background-color: #1DD1A1; border:none;" class="btn btn-success"><b>Submit</b></button>
            </div>
        </form>
    </div>
</div>
...
<div class="modal fade" id="forgotPassword2Modal" tabindex="-1" role="dialog" aria-labelledby="forgotPasswordModalLabel2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="col-md-12 w-100 px-5">
    <form action="patient-backend/verify-reset-code-patient.php" method="post">
            <div class="col-md-12 form-group mt-3 justify-content-center d-flex px-5" style="flex-direction: column;">
...
<div class="modal fade" id="forgotPassword3Modal" tabindex="-1" role="dialog" aria-labelledby="forgotPasswordModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="col-md-12 w-100 px-5">
    <form action="patient-backend/update-password-patient.php" method="post">
            <div class="col-md-12 form-group mt-3 justify-content-center d-flex px-5" style="flex-direction: column;">
            <div class="password-input-container">
                <label for="newPassword" class="d-block mb-1"><b>New Password:<span style="color:red;">*</span></b></label>
                <input type="password" name="newPassword" id="newPassword" class="form-control" placeholder="New Password" oninput="preventSpaces(event)">
            ...
            <div class="password-input-container">
                ...
                <input type="password" name="confirmNewPassword" id="confirmNewPassword" class="form-control" placeholder="New Password" oninput="preventSpaces(event)">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const submitButton = document.getElementById('forgot-pass-submit');
