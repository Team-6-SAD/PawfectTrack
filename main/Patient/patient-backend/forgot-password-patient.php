...
require_once '../../backend/src/Exception.php';
require_once '../../backend/src/PHPMailer.php';
require_once '../../backend/src/SMTP.php';
...
if(isset($_POST['email'])) {
    ...
    $checkEmailQuery = "SELECT * FROM contactinformation WHERE EmailAddress = ?";
