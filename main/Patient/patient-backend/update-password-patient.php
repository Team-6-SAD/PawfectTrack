...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $adminIDQuery = "SELECT PatientID FROM contactinformation WHERE EmailAddress = ?";
    ...
    $updateSql = "UPDATE usercredentials SET Password = ? WHERE PatientID = ?";
    ...
    if (mysqli_stmt_affected_rows($stmt) > 0) {
        ...
        header("Location: ../Patient Login.php"); // Redirect to login page or wherever appropriate
        exit();
    } else {
