  ...
  <div class="step-indicator" id="step-indicator">
    ...
    <div class="step-item">
      <span class="number">2</span>
                ...
                <div class="form-container">
  <div class="step-indicator" id="step-indicator">
    <div class="step-item mr-5 ml-4">
      <div class="text-indicator active">Patient Details</div>
    </div>
  
    <div class="step-item ml-4 mr-3">
...
<div id="equipmentItems">
    ...
    <select id="treatmentCategory" name="treatmentCategory" class="form-control" required readonly>
        <option value="Pre-exposure" selected>Pre-exposure</option>
    </select>
</div>
...
$('#step1').on('input change', 'input, select, textarea', function () {
    saveFormData();
});
