...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $emergencyPhoneNumber = $_POST['emergencyPhoneNumber'];
        ...
        $suffix = $_POST['suffix'];
        $customSuffix = $_POST['customSuffix'];
        $finalSuffix = ($suffix === "Other") ? $customSuffix : $suffix;

    // Insert patient data into the database
    $patientInsertQuery = "INSERT INTO patient (FirstName, MiddleName, LastName, BirthDate, Age, Sex, Weight, Suffix) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $patientStmt = mysqli_prepare($conn, $patientInsertQuery);
    mysqli_stmt_bind_param($patientStmt, "ssssssds", $fName, $mName, $lName, $birthDate, $age, $sex, $weight, $finalSuffix);
