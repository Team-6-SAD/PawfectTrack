...
?>
            ...
            <div class="dropdown-content" id="dropdownContent">
                ...
                <a href="backend/logout.php" style="font-size: 12px; color:#5e6e82;"  class="text-left"><img src="img/img-navbar/logout.png" class="navbar-pictures-sub ml-1 mr-2">Logout</a>
                </div>
            </div>
        </div>
    </nav>
