...
<nav id="sidebar" class="sidebar">
    <div class="container p-0 m-0 mt-2">
        ...
        <img src="img/img-navbar/System Logo.png" class="img-small mr-5" alt="Description of the image">
    </div>
    ...
    <div class="sidebar-content">
        ...
        <a href="admindashboard.php" class="sidebar-link <?php if ($activePage === 'admindashboard.php') echo 'active'; ?>">
            <div class="sidebar-item <?php if ($activePage === 'admindashboard.php') echo 'active'; ?>" data-default-icon="img/img-navbar/Dashboard.png" data-hover-icon="img/img-navbar/Dashboard-hover.png">
        ...
        <a href="patient-list.php" class="sidebar-link <?php if ($activePage === 'patient-list.php') echo 'active'; ?>">
            <div class="sidebar-item <?php if ($activePage === 'patient-list.php') echo 'active'; ?>" data-default-icon="img/img-navbar/Patient List.png" data-hover-icon="img/img-navbar/Patient List-hover.png">
        ...
        <a href="Inventory.php" class="sidebar-link <?php if ($activePage === 'Inventory.php') echo 'active'; ?>">
            <div class="sidebar-item <?php if ($activePage === 'Inventory.php') echo 'active'; ?>" data-default-icon="img/img-navbar/Inventory.png" data-hover-icon="img/img-navbar/Inventory-hover.png">
        ...
        <a href="Reports and Analytics.php" class="sidebar-link <?php if ($activePage === 'Reports and Analytics.php') echo 'active'; ?>">
            <div class="sidebar-item <?php if ($activePage === 'Reports and Analytics.php') echo 'active'; ?>" data-default-icon="img/img-navbar/Reports and Analytics.png" data-hover-icon="img/img-navbar/Reports and Analytics-hover.png">
        ...
        <a href="Archival.php" class="sidebar-link <?php if ($activePage === 'Archival.php') echo 'active'; ?>">
            <div class="sidebar-item <?php if ($activePage === 'Archival.php') echo 'active'; ?>" data-default-icon="img/img-navbar/Archival.png" data-hover-icon="img/img-navbar/Archival-hover.png">
