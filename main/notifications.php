...
WHERE 
    ...
    AND (mb.dismissed_at IS NULL OR mb.dismissed_at < DATE_SUB(NOW(), INTERVAL 15 MINUTE))
";
...
WHERE 
    ...
    AND (mi.dismissed_at IS NULL OR mi.dismissed_at < DATE_SUB(NOW(), INTERVAL 15 MINUTE))
";
